...
public class PageableFindPlugin extends PageablePlugin {
	...
	public boolean clientSelectByExampleWithBLOBsMethodGenerated(Method method,
        ...
        if (introspectedTable.getTargetRuntime() == IntrospectedTable.TargetRuntime.MYBATIS3) {
            addParamNameToSelectByExample(method, interfaze);
	...
	public boolean sqlMapSelectByExampleWithoutBLOBsElementGenerated(
        ...
        if (introspectedTable.getTargetRuntime() == IntrospectedTable.TargetRuntime.MYBATIS3) {
            ...
            addParamNameToSelectByExampleElement(element, introspectedTable.getFullyQualifiedTable());
        }
        return true;
	}
    ...
    private void addParamNameToSelectByExampleElement(XmlElement element, FullyQualifiedTable fqt) {
        ...
        if ("select".equals(selectByExampleElement.getName())) {
            for (Attribute attribute : selectByExampleElement.getAttributes()) {
                if ("id".equals(attribute.getName()) && "selectByExample".equals(attribute.getValue())) {
                    for (Element innerElement : selectByExampleElement.getElements()) {
                        if (innerElement instanceof XmlElement) {
                            ...
                            if ("if".equals(ifOrderByClauseElement.getName()) && ifOrderByClauseElement.getAttributes().size() == 1) {
                                Attribute conditionAttribute = ifOrderByClauseElement.getAttributes().get(0);
